...
<!-- #include file="topo.asp" -->
	...
	<div id="conteudo">
<h1>Tutorial: Trocando o Layout de seu Site de Forma Dinâmica com Style Sheet.</h1>
...
<p>Para deixar um style sheet como preferred, basta setar o atributo 'rel' como "stylesheet" e nomear este com um atributo 'tittle'.</p>
<p><b>Nota:</b> Mais de um link de relacionamento pode conter o atributo 'tittle' idênticos. Eles serão ativados e desativados em conjunto. Se mais de um link de relacionamento estiver setado como preferred no documento, o primeiro link que for lido é o que vai ser acionado.</p>
...
<pre>&lt;link rel="stylesheet" type="text/css" 
href="orange.css" tittle="fundo laranja"></pre>
<p><b>Alternate</b></p>
...
<p>Para especificar um link como alternate, basta dar ao atributo 'rel' o valor  "alternate stylesheet" e dar um nome para o atributo 'tittle'. Mais de um link pode ser especificado como alternate e inclusive receber valores para o atributo 'tittle' idênticos,  para serem acionados em grupos, se necessário.</p>
...
href="orange.css" tittle="layout laranja" /></pre>
...
<h1>Trocando o Layout do Site:</h1>
...
<p>Isto é um atributo Tittle?</p>
<pre>HTMLListElement.getAttribute("tittle")</pre>
