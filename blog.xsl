...
<xsl:template match="elcio">
	postado por <a href="http://elcio.locaweb.com.br/" title="fechaTAG &lt;the brógui&gt; - XML XHTML CSS WAP ASP Javascript VBScript Usabilidade Acessibilidade">Elcio Luiz Ferreira</a>
</xsl:template>
